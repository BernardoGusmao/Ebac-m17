...
with sns.axes_style('whitegrid'):
  ...
  grafico.set_xlabel('Dias')
  grafico.set_ylabel('Preço médio de vendas')
  grafico.set_title('Preço médio de venda da gasolina na cidade de São Paulo nos 10 primeiros dias de Julho de 2021.', fontweight='bold')
